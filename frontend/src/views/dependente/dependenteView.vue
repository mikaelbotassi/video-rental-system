    ...
    <main class="d-flex align-items-center justify-content-center shadow">
        <div class="container">
            <header class="d-flex align-items-center justify-content-between mb-5">
                <h1 class="text-dark">Lista de Dependentes</h1>
        ...
        <DependenteForm :open="isOpen" @close="cancelChange" @saved="refreshList" :editedId="editedId"/>
    </main>
</template>
...
import DependenteForm from './dependenteForm.vue';
import Swal from 'sweetalert2';
import Dependente from "../../models/dependente";

export default defineComponent({
    name:'DependenteView',
    components: { DependenteForm },
    setup() {

        const { entities, getAll, destroy } = useRequests(Dependente);
